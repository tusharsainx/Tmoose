      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemCount: controller.topTracks?.length ?? 0,
                ...
                children: [
                  SizedBox(
                    ...
                    child: CachedNetworkImage(
                      imageUrl:
                          controller.topTracks?[index].backgroundImage ?? "",
                  ...
                  SizedBox(
                    width: 100,
                    child: Text(
                      "${index + 1}. ${controller.topTracks?[index].trackName}",
                  ...
                  Text(
                    controller.topTracks?[index].artists?[0].artistName ??
                        "Unknown Artist",
